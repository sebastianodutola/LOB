...
render_optimisation_figures(optimal_data_path, output_dir=fig_output_dir)
render_optimisation_analysis_report(optimal_data_path, output_path=md_output_path)
